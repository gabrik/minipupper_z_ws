...
def callback(data):
    ...
    print(f'[Legacy] Actuation took {end_time.secs - data.header.stamp.secs}s and {end_time.nsecs - data.header.stamp.nsecs}')
...
def listener():
    ...
    parser.add_argument('-c','--connect', help='Zenoh connect locator', required=False, type=str, default='')
